  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-blue-200 to-indigo-300 p-6">
      <div className="max-w-4xl mx-auto font-serif bg-purple-100 rounded-lg p-8">
        ...
        <p className="text-lg text-gray-800 leading-relaxed mb-6">
          AICCT in itself consists of wide range of possibilities which are increasing exponentially day by day. To cope up with increasing global need for high performance, more efficiency, and optimized output; advance computing technologies are the growing research area in the field of ICCT. Although various high performance models such as cluster computing, Grid computing and cloud computing have been proposed but these models are still looking for big hands in research. So, Intelligent Computing has been one of the most promising research areas throughout the globe for some decades now.
        </p>
        <p className="text-lg text-gray-800 leading-relaxed mb-6">
          With this thought in mind, Department of Computer Science and Engineering, United University, Prayagraj, Uttar Pradesh (India) has planned to bring together the Intelligent Computing research community through 1st IEEE International Conference on Intelligent Computing and Communication Technology (AICCT-2025), Sepetember 12-13, 2025.
        </p>
