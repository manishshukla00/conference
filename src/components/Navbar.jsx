...
const Navbar = () => {
  ...
  return (
    <div
      className="w-full bg-black bg-opacity-20 backdrop-blur-md absolute top-0 left-0 z-50"
      style={{ fontFamily: "'Montserrat', 'Roboto', Arial, sans-serif" }}
    >
      <nav
        className="w-full max-w-screen-xl mx-auto flex justify-between items-center px-4 sm:px-6 lg:px-8 py-4"
        style={{ fontFamily: "'Montserrat', 'Roboto', Arial, sans-serif" }}
      >
        {/* Logo */}
        ...
        <div
          className="hidden md:flex items-center gap-6 font-bold relative"
        ...
        >
          ...
          <div className="relative">
            ...
            >
              ...
              <svg
                className={`w-4 h-4 ml-2 transform ${
                  openDropdown === "committee" ? "rotate-180" : "rotate-0"
            ...
            {openDropdown === "committee" && (
              <div className="absolute top-full left-0 mt-2 w-56 bg-white shadow-lg rounded-lg z-10">
                <Link
                  to="/committee-member"
      ...
      {isMenuOpen && (
        <div
          className="absolute top-0 left-0 w-full h-screen bg-black bg-opacity-80 text-white flex flex-col items-center justify-center space-y-6 z-40 transition-all duration-300 ease-in-out"
          style={{ fontFamily: "'Montserrat', 'Roboto', Arial, sans-serif" }}
        >
          {/* Close Button */}
          <button
          ...
          <div className="flex flex-col items-center">
            <span className="text-2xl font-bold mb-2">Committee</span>
            <Link
              to="/committee-member"
              onClick={toggleMenu}
