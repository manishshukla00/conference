...
const ImportantDates = () => {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 bg-gradient-to-r from-blue-500 via-purple-600 to-pink-500 rounded-lg shadow-lg py-6">
      <h2 className="text-4xl font-bold text-center text-white mb-4">
        Important{" "}
        <span className="text-orange-300 font-serif font-thin">Dates</span>
      </h2>
