...
const committeeData = [
    ...
    {
      title: 'General Chair',
      members: ['Dr. Prashant Shukla, HoD (CSE), United University, Prayagraj, India'],
    },
    {
...
const CommitteMember = () => {
    ...
    return (
        <div className="p-6">
          <h1 className="text-4xl font-extrabold text-center mb-8 text-blue-800 font-serif">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {committeeData.map((committee, index) => (
              ...
              >
                <h2 className="text-2xl font-bold mb-4 text-center font-sans">{committee.title}</h2>
